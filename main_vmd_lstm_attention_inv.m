...
% pathname=['.\Alldata\RandiData2D\'];%%pseudo-two dimensional
...
Input_theory= Input;
 ...
 switch nStrata
     case 3
          load woa-mvmd_data_3layer.mat   
          % load woa-mvmd_data_3layer2D.mat   
     case 4
         load woa-mvmd_data_4layer.mat   
     case 5
         load woa-mvmd_data_5layer.mat   
     case 6
         load woa-mvmd_data_6layer.mat   
 end
%% ===============================traing data==================================
...
analyzeNetwork(Mdl)  
%% Preserving the training model VMD-LSTM-Attention
% pathname=['.\TrainModelNet\',num2str(nStrata),'-Layer2D\'];%%pseudo-two dimensional
pathname=['.\TrainModelNet\',num2str(nStrata),'-Layer\'];
if exist(pathname,'dir') == 0
    mkdir(pathname);
end
filename='vmd_lstm_attention_net.mat';
